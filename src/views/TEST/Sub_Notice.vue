<template>
  <div style="width: 90%; margin: 5%">
    <modals-container />
    <div class="common-schwrap" style="height: 50px">공지사항</div>
...
import { SELECT_NOT, SELECT_NOTI } from "@/api/Test_map.js"; // 이전에 사용중인 공지사항 조회, 현재 사용중인 공지사항 조회(2020.10.13 KOY),
